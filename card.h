...
public:
  ...
  enum Value
	...
	// Compares if the card suit and face value of the left card is less than the right.  
	// @param[in]	rhs   The right hand side card.
	// @return	  true if less than.
	bool operator< (const Card& rhs);

	// Compares if the card suit and face value of the left card is less than or equal the right.  
	// @param[in]	rhs   The right hand side card.
  ...
  bool operator<= (const Card& rhs) const;
	...
	// Compares if the card suit and face value of the left card is greater than the right.  
	// @param[in]	rhs   The right hand side card.
	// @return	  true if greater than.
	bool operator> (const Card& rhs);

	// Compares if the card suit and face value of the left card is greater than or equal the right.  
	// @param[in]	rhs   The right hand side card.
